    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 text-sm mt-1">
          Assessments are attached to a specific vacancy along with their questions and pass marks. Create and manage
          them from the vacancy they belong to.
        </p>
      </div>
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="text-sm text-slate-600 mt-1">
          Open a vacancy to configure its online MCQ, essay, scenario or offline assessments and the auto-scored
          question key.
        </p>
        <Link
