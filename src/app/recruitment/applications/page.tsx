...
export default function MasterApplicationsPage() {
  ...
  const statuses = APPLICATION_STAGES
        ...
        <div className="page-shell space-y-7">
              ...
              {views.map((view) => (
                ...
                >
                  <button
                    ...
                    className="px-3 py-1.5 text-xs font-semibold text-stone-700 hover:bg-stone-50"
                  >
                    {view.name}
                  </button>
                  <button
                    ...
                    className="border-l border-stone-200 px-2 text-stone-400 hover:text-rose-700"
                  >
                    ×
                  </button>
                </span>
          ...
          <section className="section-panel">
            <div className="grid gap-3 border-b border-stone-200 p-4 sm:grid-cols-[1fr_220px_auto]">
              ...
              <button type="button" onClick={() => setSaveOpen(true)} className="btn-secondary">
                Save view
              </button>
            </div>
            <div className="flex items-center justify-between border-b border-stone-200 px-4 py-3 text-xs text-stone-500">
              ...
              <div className="flex items-center gap-3">
                <button onClick={() => setCompact(!compact)} className="font-semibold text-brand-800 underline">
      ...
      <Dialog open={saveOpen} onClose={() => setSaveOpen(false)} title="Save this application view">
        ...
        >
          <p className="text-sm text-stone-600">
            This view stores the current search and stage filter in this browser.
          </p>
          <label className="block">
            ...
            <input
              ...
              placeholder="For example: New finance applications"
            />
          </label>
          <div className="flex justify-end gap-2">
            <button type="button" onClick={() => setSaveOpen(false)} className="btn-secondary">
              Cancel
            </button>
