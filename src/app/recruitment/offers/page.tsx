                ...
                {offers.length === 0 ? (
                  ...
                  offers.map((o) => (
                    <tr key={o.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 space-y-2"><span className={`px-2.5 py-1 rounded-full text-xs font-bold border ${getStatusBadgeClass(o.status)}`}>{o.status}</span><OfferActions id={o.id} status={o.status} /></td>
                    </tr>
                  ))
                )}
              </tbody>
