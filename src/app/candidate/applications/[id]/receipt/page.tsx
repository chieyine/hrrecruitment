        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <article className="section-panel p-6 sm:p-10 print:border-0 print:p-0 print:shadow-none">
            ...
            <dl className="grid gap-x-8 gap-y-5 py-7 text-sm sm:grid-cols-2">
              <div>
                <dt className="text-xs font-semibold text-stone-500">Role</dt>
                <dd className="mt-1 font-bold text-stone-900">{application.vacancy.title}</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold text-stone-500">Vacancy reference</dt>
                <dd className="mt-1 font-mono text-stone-900">{application.vacancy.referenceNumber}</dd>
              </div>
              <div>
              ...
              <div>
                ...
                <dd className="mt-1 text-stone-900">{application.vacancy.department.name}</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold text-stone-500">Location</dt>
                <dd className="mt-1 text-stone-900">{application.vacancy.dutyStation.name}</dd>
              </div>
              <div>
            ...
            <div className="border-t border-stone-200 pt-5">
              ...
              <p className="mt-2 text-sm leading-6 text-stone-600">
                The recruitment team will review applications after the vacancy closes. If you need to complete an
                assessment, attend an interview or provide more information, the request will appear in your account.
              </p>
            </div>
            <div className="mt-7 flex flex-wrap gap-2 print:hidden">
              <Link href={`/candidate/applications/${application.id}`} className="btn-primary">
                View application
              </Link>
              <PrintButton />
