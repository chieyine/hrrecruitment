...
export default function CandidateEducationPage() {
  ...
  useEffect(() => {
    void loadData().catch((reason) =>
      setError(reason instanceof Error ? reason.message : 'Unable to load education history')
    )
  }, [loadData])
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
        ...
        {showForm && (
          ...
          >
            ...
            <div className="flex justify-end gap-2">
              ...
              >
                {busy ? 'Saving…' : editingId ? 'Update Record' : 'Save Record'}
              </button>
            </div>
          </form>
        )}
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <h3 className="font-bold text-slate-900 text-lg">
                  {education.qualification} in {education.fieldOfStudy}
                </h3>
      ...
      <ConfirmDialog
        ...
        onConfirm={() => (deleteTarget ? deleteEducation(deleteTarget) : undefined)}
        title="Delete education record"
        description={
          deleteTarget
            ? `Delete ${deleteTarget.qualification} at ${deleteTarget.institution}? This cannot be undone.`
            : ''
        }
