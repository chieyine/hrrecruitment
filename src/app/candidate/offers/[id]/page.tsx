...
export default async function CandidateOfferPage(props: { params: Promise<{ id: string }> }) {
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <input id="proposed-start-date" type="date" min={new Date(Date.now() + 86_400_000).toISOString().slice(0, 10)} value={proposedStartDate} onChange={(event) => setProposedStartDate(event.target.value)} className="w-full rounded-xl border border-slate-300 p-2.5 focus:border-blue-600 focus:outline-none" />
                </div>
                <div>
