        ...
        <div className="mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl lg:grid-cols-[.9fr_1.1fr]">
          ...
          <section className="flex items-center px-4 py-12 sm:px-10 lg:px-20">
            <div className="mx-auto w-full max-w-md">
              <span className="editorial-kicker">Candidate and staff sign-in</span>
              ...
              {error && (
                <div
                  role="alert"
                  className="mt-6 flex items-center gap-3 border border-rose-200 bg-rose-50 p-4 text-xs font-medium text-rose-800"
                >
              ...
              {challengeToken ? (
                <form className="mt-8 space-y-5" onSubmit={handleMfaSubmit}>
                  <div>
                    <label
                      ...
                      className="mb-2 block text-[10px] font-bold uppercase tracking-[0.14em] text-muted"
                    >
                      Authentication code
                    </label>
                ...
                <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                  ...
                  <button type="submit" disabled={loading} className="btn-primary flex h-12 w-full disabled:opacity-50">
