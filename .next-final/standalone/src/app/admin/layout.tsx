...
const NAV_GROUPS: AdminNavGroup[] = [
  ...
  { label: 'Preboarding', items: [
    { href: '/admin/document-types', label: 'Document types' }, { href: '/admin/document-requirements', label: 'Document requirements' }, { href: '/admin/forms', label: 'Forms' }, { href: '/admin/policies', label: 'Policies' }, { href: '/admin/courses', label: 'Courses' }, { href: '/admin/tasks', label: 'Tasks' }, { href: '/admin/preboarding-packages', label: 'Packages' },
  ] },
  { label: 'Communication', items: [
    { href: '/admin/notification-templates', label: 'Notifications' }, { href: '/admin/templates', label: 'Offers' },
  ] },
  { label: 'Control', items: [
    { href: '/admin/users', label: 'Users' }, { href: '/admin/roles', label: 'Roles' }, { href: '/admin/permissions', label: 'Permissions' }, { href: '/admin/system-settings', label: 'System' }, { href: '/admin/deletion-requests', label: 'Privacy' }, { href: '/admin/governance', label: 'Governance' }, { href: '/admin/operating-model', label: 'Operating model' }, { href: '/admin/fraud-reports', label: 'Fraud reports' },
  ] },
]
