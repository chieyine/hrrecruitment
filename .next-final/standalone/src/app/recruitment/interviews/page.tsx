          ...
          <div className="space-y-3">
            {interviews.length === 0 ? (
              ...
              interviews.map((iv) => {
                ...
                return (
                  <div id={`interview-${iv.id}`} key={iv.id} className="scroll-mt-24 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      {canManage && (
                        <InterviewCoordinationActions
                          ...
                          panelMembers={iv.panelMembers.map((member) => ({
                            ...
                            hasSubmitted: iv.panelSubmissions.some((submission) => submission.panelMemberId === member.id),
                          }))}
                        />
                      )}
                    </div>
